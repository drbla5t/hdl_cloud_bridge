...
from app.handlers import generic as cmd_generic
...
from app.state_handlers import generic as state_generic
...
from app.discovery_handlers import generic as disc_generic
...
DEVICE_REGISTRY = {
    ...
    "other.common": {
        "command": cmd_generic.handle_generic_command,
        "state": state_generic.publish,
